...
class GcpDummyProvisionProvider extends AbstractProvisionProvider implements WorkloadProvisionProvider {
	public static final String PROVISION_PROVIDER_CODE = 'GcpDummy.provision'

	protected MorpheusContext context
	protected Plugin plugin

	public GcpDummyProvisionProvider(Plugin plugin, MorpheusContext ctx) {
		super()
		this.@context = ctx
		this.@plugin = plugin
	}
